...
export class CompanyService {  
  ...
  GetById(idCompany: number): Observable<CompanyDTO> {
    
    return this.http.get<CompanyDTO>(`${this.apiUrl}GetById/${idCompany}`).pipe(
  ...
  update(company: CompanyDTO): Observable<CompanyDTO> {
    return this.http.put<CompanyDTO>(`${this.apiUrl}UpdateAdmin`, company);
  }

  create(company: CompanyDTO): Observable<CompanyDTO> {
    return this.http.post<CompanyDTO>(`${this.apiUrl}Create`, company);
  }
}
