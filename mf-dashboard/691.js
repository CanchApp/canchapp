(self["webpackChunkmf_dashboard"] = self["webpackChunkmf_dashboard"] || []).push([[691],{
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ 8648);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/operators */ 2778);
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/platform-browser */ 63);
...
class ActivatedRoute {
  ...
  component, futureSnapshot) {
    ...
    this.title = this.dataSubject?.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(d => d[RouteTitleKey])) ?? (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(undefined);
...
const INPUT_BINDER = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken('');
/**
...
let RoutedComponentInputBinder = /*#__PURE__*/(() => {
  class RoutedComponentInputBinder {
    ...
    subscribeToRouteData(outlet) {
      ...
      const dataSubscription = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.combineLatest)([activatedRoute.queryParams, activatedRoute.params, activatedRoute.data]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(([queryParams, params, data], index) => {
        data = {
          ...queryParams,
          ...params,
          ...data
...
const activateRoutes = (rootContexts, routeReuseStrategy, forwardEvent, inputBindingEnabled) => (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(t => {
...
function isEmptyError(e) {
  return e instanceof rxjs__WEBPACK_IMPORTED_MODULE_2__.EmptyError || e?.name === 'EmptyError';
}
const INITIAL_VALUE = /* @__PURE__ */Symbol('INITIAL_VALUE');
function prioritizedGuardValue() {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(obs => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.combineLatest)(obs.map(o => o.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.startWith)(INITIAL_VALUE)))).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(results => {
      ...
      return true;
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(item => item !== INITIAL_VALUE), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.take)(1));
  });
}
function checkGuards(injector, forwardEvent) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(t => {
    const {
      targetSnapshot,
      currentSnapshot,
      guards: {
    ...
    return runCanDeactivateChecks(canDeactivateChecks, targetSnapshot, currentSnapshot, injector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(canDeactivate => {
...
function runCanDeactivateChecks(checks, futureRSS, currRSS, injector) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(checks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(check => runCanDeactivate(check.component, check.route, currRSS, futureRSS, injector)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.first)(result => {
    return result !== true;
  }, true));
}
function runCanActivateChecks(futureSnapshot, checks, injector, forwardEvent) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(checks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.concatMap)(check => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.concat)(fireChildActivationStart(check.route.parent, forwardEvent), fireActivationStart(check.route, forwardEvent), runCanActivateChild(futureSnapshot, check.path, injector), runCanActivate(futureSnapshot, check.route, injector));
  }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.first)(result => {
    return result !== true;
  }, true));
}
/**
...
function runCanActivate(futureRSS, futureARS, injector) {
  ...
  const canActivateObservables = canActivate.map(canActivate => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.defer)(() => {
      ...
      return wrapIntoObservable(guardVal).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.first)());
    });
  });
...
function redirectIfUrlTree(urlSerializer) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.pipe)((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(result => {
...
function noMatch$1(segmentGroup) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.throwError)(new NoMatch(segmentGroup));
}
function absoluteRedirect(newTree) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.throwError)(new AbsoluteRedirect(newTree));
}
function namedOutletsRedirect(redirectTo) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.throwError)(new _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵRuntimeError"](4000 /* RuntimeErrorCode.NAMED_OUTLET_REDIRECT */, (typeof ngDevMode === 'undefined' || ngDevMode) && `Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`));
}
function canLoadFails(route) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.throwError)(navigationCancelingError((typeof ngDevMode === 'undefined' || ngDevMode) && `Cannot load children because the guard of the route "path: '${route.path}'" returned false`, NavigationCancellationCode.GuardRejected));
}
...
class Recognizer {
  ...
  recognize() {
    ...
    return this.match(rootSegmentGroup).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(children => {
  ...
  match(rootSegmentGroup) {
    ...
    return expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(e => {
  ...
  processSegmentGroup(injector, config, segmentGroup, outlet) {
    ...
    return this.processSegment(injector, config, segmentGroup, segmentGroup.segments, outlet, true).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(child => child instanceof TreeNode ? [child] : []));
  }
  /**
  ...
  processChildren(injector, config, segmentGroup) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(childOutlets).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.concatMap)(childOutlet => {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.scan)((children, outletChildren) => {
      children.push(...outletChildren);
      return children;
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.defaultIfEmpty)(null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.last)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(children => {
      ...
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(mergedChildren);
    }));
  }
  processSegment(injector, routes, segmentGroup, segments, outlet, allowRedirects) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(routes).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.concatMap)(r => {
      return this.processSegmentAgainstRoute(r._injector ?? injector, routes, r, segmentGroup, segments, outlet, allowRedirects).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(e => {
        if (e instanceof NoMatch) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(null);
        }
        throw e;
      }));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.first)(x => !!x), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(e => {
      if (isEmptyError(e)) {
        if (noLeftoversInUrl(segmentGroup, segments, outlet)) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(new NoLeftoversInUrl());
        }
  ...
  expandSegmentAgainstRouteUsingRedirect(injector, segmentGroup, routes, route, segments, outlet) {
    ...
    return this.applyRedirects.lineralizeSegments(route, newTree).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(newSegments => {
  ...
  matchSegmentAgainstRoute(injector, rawSegment, route, segments, outlet) {
    ...
    return matchResult.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(result => {
      if (!result.matched) {
        return noMatch$1(rawSegment);
      }
      // If the route has an injector created from providers, we should start using that.
      injector = route._injector ?? injector;
      return this.getChildConfig(injector, route, segments).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(({
        routes: childConfig
      }) => {
        ...
        return this.processSegment(childInjector, childConfig, segmentGroup, slicedSegments, matchedOnOutlet ? PRIMARY_OUTLET : outlet, true).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(child => {
  ...
  getChildConfig(injector, route, segments) {
    ...
    if (route.loadChildren) {
      ...
      return runCanLoadGuards(injector, route, segments, this.urlSerializer).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(shouldLoadResult => {
        if (shouldLoadResult) {
          return this.configLoader.loadChildren(injector, route).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(cfg => {
...
function recognize(injector, configLoader, rootComponentType, config, serializer, paramsInheritanceStrategy) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(t => recognize$1(injector, configLoader, rootComponentType, config, t.extractedUrl, serializer, paramsInheritanceStrategy).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(({
...
function resolveData(paramsInheritanceStrategy, injector) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(t => {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(routesNeedingDataUpdates).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.concatMap)(route => {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(() => routesProcessed++), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(_ => routesProcessed === routesNeedingDataUpdates.size ? (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(t) : rxjs__WEBPACK_IMPORTED_MODULE_2__.EMPTY));
  });
}
/**
...
function resolveNode(resolve, futureARS, futureRSS, injector) {
  ...
  const data = {};
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(keys).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(key => getResolver(resolve[key], futureARS, futureRSS, injector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.first)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(value => {
    data[key] = value;
  }))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mapTo)(data), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(e => isEmptyError(e) ? rxjs__WEBPACK_IMPORTED_MODULE_2__.EMPTY : (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.throwError)(e)));
}
...
function switchTap(next) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(v => {
    const nextResult = next(v);
    if (nextResult) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(nextResult).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(() => v));
    }
  ...
  class DefaultTitleStrategy extends TitleStrategy {
    ...
    static {
      this.ɵfac = function DefaultTitleStrategy_Factory(t) {
        return new (t || DefaultTitleStrategy)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__.Title));
      };
    }
    static {
      this.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
 ...
 * @publicApi
 */
const ROUTER_CONFIGURATION = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'router config' : '', {
  providedIn: 'root',
  factory: () => ({})
});
 ...
 * @publicApi
 */
const ROUTES = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken(ngDevMode ? 'ROUTES' : '');
let RouterConfigLoader = /*#__PURE__*/(() => {
  class RouterConfigLoader {
    ...
    loadComponent(route) {
      ...
      const loadRunner = wrapIntoObservable(route.loadComponent()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(maybeUnwrapDefaultExport), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(component => {
      ...
      const loader = new rxjs__WEBPACK_IMPORTED_MODULE_2__.ConnectableObservable(loadRunner, () => new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.refCount)());
    ...
    loadChildren(parentInjector, route) {
      ...
      const loadRunner = moduleFactoryOrRoutes$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.finalize)(() => {
...
function loadChildren(route, compiler, parentInjector, onLoadEndListener) {
  return wrapIntoObservable(route.loadChildren()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(maybeUnwrapDefaultExport), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(t => {
  ...
  }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(factoryOrRoutes => {
...
const CREATE_VIEW_TRANSITION = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken(ngDevMode ? 'view transition helper' : '');
const VIEW_TRANSITION_OPTIONS = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken(ngDevMode ? 'view transition options' : '');
/**
...
function createViewTransition(injector, from, to) {
  ...
  const document = injector.get(_angular_common__WEBPACK_IMPORTED_MODULE_3__.DOCUMENT);
...
let NavigationTransitions = /*#__PURE__*/(() => {
  class NavigationTransitions {
    ...
    constructor() {
       ...
       */
      this.transitionAbortSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
      ...
      this.location = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_3__.Location);
    ...
    setupNavigations(router, initialUrlTree, initialRouterState) {
      ...
      return this.transitions.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(t => t.id !== 0),
      // Extract URL
      ...
      (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(overallTransitionState => {
        let completed = false;
        let errored = false;
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(overallTransitionState).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(t => {
          ...
          if (this.urlHandlingStrategy.shouldProcessUrl(t.rawUrl)) {
            ...
            (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(t => {
            ...
            (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(t => {
        ...
        }), checkGuards(this.environmentInjector, evt => this.events.next(evt)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(t => {
        ...
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(t => {
          if (!t.guardsResult) {
        ...
        switchTap(t => {
          if (t.guards.canActivateChecks.length) {
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(t).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(t => {
              const resolveStart = new ResolveStart(t.id, this.urlSerializer.serialize(t.extractedUrl), this.urlSerializer.serialize(t.urlAfterRedirects), t.targetSnapshot);
              this.events.next(resolveStart);
            }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(t => {
              let dataResolved = false;
              return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(t).pipe(resolveData(this.paramsInheritanceStrategy, this.environmentInjector), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)({
        ...
        switchTap(t => {
          const loadComponents = route => {
            ...
            if (route.routeConfig?.loadComponent && !route.routeConfig._loadedComponent) {
              loaders.push(this.configLoader.loadComponent(route.routeConfig).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(loadedComponent => {
          ...
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.combineLatest)(loadComponents(t.targetSnapshot.root)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.defaultIfEmpty)(null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.take)(1));
        }), switchTap(() => this.afterPreactivation()), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(() => {
          const {
            currentSnapshot,
            targetSnapshot
          ...
          return viewTransitionStarted ? (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(viewTransitionStarted).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(() => overallTransitionState)) : (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(overallTransitionState);
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(t => {
        ...
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)({
          next: t => {
            completed = true;
        ...
        // transition.
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.takeUntil)(this.transitionAbortSubject.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(err => {
          throw err;
        }))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.finalize)(() => {
...
function afterNextNavigation(router, action) {
  router.events.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(e => e instanceof NavigationEnd || e instanceof NavigationCancel || e instanceof NavigationError || e instanceof NavigationSkipped), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(e => {
    if (e instanceof NavigationEnd || e instanceof NavigationSkipped) {
      return NavigationResult.COMPLETE;
    }
    const redirecting = e instanceof NavigationCancel ? e.code === NavigationCancellationCode.Redirect || e.code === NavigationCancellationCode.SupersededByNewNavigation : false;
    return redirecting ? NavigationResult.REDIRECTING : NavigationResult.FAILED;
  }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(result => result !== NavigationResult.REDIRECTING), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.take)(1)).subscribe(() => {
    action();
  });
}
...
let Router = /*#__PURE__*/(() => {
  class Router {
    ...
    constructor() {
      ...
      this.eventsSubscription = new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subscription();
...
let RouterLinkActive = /*#__PURE__*/(() => {
  class RouterLinkActive {
    ...
    ngAfterContentInit() {
      ...
      (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(this.links.changes, (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(null)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeAll)()).subscribe(_ => {
        this.update();
    ...
    subscribeToEachLinkOnChanges() {
      ...
      this.linkInputChangesSubscription = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(allLinkChanges).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeAll)()).subscribe(link => {
...
let PreloadAllModules = /*#__PURE__*/(() => {
  class PreloadAllModules {
    preload(route, fn) {
      return fn().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(null)));
    }
    static {
...
let RouterPreloader = /*#__PURE__*/(() => {
  class RouterPreloader {
    ...
    setUpPreloading() {
      this.subscription = this.router.events.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(e => e instanceof NavigationEnd), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.concatMap)(() => this.preload())).subscribe(() => {});
    }
    preload() {
    ...
    processRoutes(injector, routes) {
      ...
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(res).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeAll)());
    }
    preloadConfig(injector, route) {
      return this.preloadingStrategy.preload(route, () => {
        ...
        const recursiveLoadChildren$ = loadedChildren$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(config => {
          if (config === null) {
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(void 0);
          }
        ...
        if (route.loadComponent && !route._loadedComponent) {
          ...
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)([recursiveLoadChildren$, loadComponent$]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeAll)());
        } else {
...
const ROUTER_SCROLLER = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken('');
let RouterScroller = /*#__PURE__*/(() => {
  class RouterScroller {
    ...
    scheduleScrollEvent(routerEvent, anchor) {
      var _this = this;
      this.zone.runOutsideAngular( /*#__PURE__*/(0,Z_Canchapp_canchapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
 ...
 * called.
 */
const ROUTER_IS_PROVIDED = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken('', {
  providedIn: 'root',
  factory: () => false
});
...
function withInMemoryScrolling(options = {}) {
  const providers = [{
    ...
    useFactory: () => {
      const viewportScroller = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_3__.ViewportScroller);
 ...
 */
const BOOTSTRAP_DONE = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'bootstrap done indicator' : '', {
  factory: () => {
    return new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject();
  }
});
const INITIAL_NAVIGATION = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'initial navigation' : '', {
  providedIn: 'root',
...
function withEnabledBlockingInitialNavigation() {
  const providers = [{
    ...
    useFactory: injector => {
      const locationInitialized = injector.get(_angular_common__WEBPACK_IMPORTED_MODULE_3__.LOCATION_INITIALIZED, Promise.resolve());
      return () => {
...
const ROUTER_PRELOADER = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'router preloader' : '');
/**
 ...
 * @docsNotRequired
 */
const ROUTER_FORROOT_GUARD = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'router duplicate forRoot guard' : 'ROUTER_FORROOT_GUARD');
// TODO(atscott): All of these except `ActivatedRoute` are `providedIn: 'root'`. They are only kept
// here to avoid a breaking change whereby the provider order matters based on where the
// `RouterModule`/`RouterTestingModule` is imported. These can/should be removed as a "breaking"
// change in a major version.
const ROUTER_PROVIDERS = [_angular_common__WEBPACK_IMPORTED_MODULE_3__.Location, {
 ...
 * @publicApi
 */
const ROUTER_INITIALIZER = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'Router Initializer' : '');
 ...
 * @publicApi
 */
const VERSION = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_1__.Version('17.3.12');
