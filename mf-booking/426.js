(self["webpackChunkmf_booking"] = self["webpackChunkmf_booking"] || []).push([[426],{
    ...
    for (let id in droppableStore) {
      ...
      offsetTracker.isWithinClipping(offsetLeft, offsetTop)) {
        ...
        positionLeft >= 0 && positionLeft < width && positionTop >= 0 && positionTop < height) {
          ...
          (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.rangeContainsRange)(hit.dateProfile.activeRange, hit.dateSpan.range) && (
...
function computeEventMutation(hit0, hit1, eventInstanceStart, massagers) {
  ...
  if (dateSpan0.allDay !== dateSpan1.allDay) {
    ...
    if (dateSpan1.allDay) {
      ...
      date0 = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.startOfDay)(eventInstanceStart);
    } else {
