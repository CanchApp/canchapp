...
(0,_angular_architects_module_federation__WEBPACK_IMPORTED_MODULE_1__.loadManifest)(getManifestPath()).then(() => __webpack_require__.e(/*! import() */ 962).then(__webpack_require__.bind(__webpack_require__, /*! ./bootstrap */ 6962))).catch(err => console.error('Error loading manifest or bootstrap:', err));
